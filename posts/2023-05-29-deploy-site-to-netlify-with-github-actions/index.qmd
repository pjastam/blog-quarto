...
The [Quarto](https://quarto.org/) website that is described in this example was automaticallynamed [https://splendorous-bublanina-d544bb.netlify.app/]{.underline}] by {{< iconify bxl netlify >}} Netlify. To remember it better, I renamed it to [https://template-quarto-website.netlify.app/](https://template-quarto-website.netlify.app/) in my {{< iconify bxl netlify >}} Netlify account. I changed the `url` field in the `_publish.yml` file accordingly. You can visit the [Quarto](https://quarto.org/) website at this URL.
...
4.  Execute step 3 of the step-by-step guide above.
...
5.  Execute step 10 of the step-by-step guide above.

6.  Execute step 11 of the step-by-step guide above.
