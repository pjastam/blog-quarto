...
6.  Execute step 11 of the [step-by-step guide](index.qmd#step-by-step-guide) for the files that are ready to commit: your newly created `_publish.yml` file and two files in the `_freeze` directory.
