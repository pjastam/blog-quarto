...
To actually use this template, there are 7 steps involved:
...
5.  Revert the two `html.json` files to their original state (i.e. the state of this repository before the previous step):

    ![](img/rstudio-revert-json-files.png)

6.  Execute step 10 of the [step-by-step guide](index.qmd#step-by-step-guide).

7.  Execute step 11 of the [step-by-step guide](index.qmd#step-by-step-guide).
