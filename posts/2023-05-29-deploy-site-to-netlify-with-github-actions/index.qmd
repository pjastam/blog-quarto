...
3.  Execute step 3 of the step-by-step guide above to add the {{< iconify bxl netlify >}} Netlify credentials of your own site to the `_publish.yml` file.

4.  Execute step 11 of the step-by-step guide above and your [Quarto](https://quarto.org/) website will be up and running any moment.
