...
3.  ~~Add a `.gitattributes` file and change the RStudio line endings setting to `None` along the lines of [my gist](https://gist.github.com/pjastam/03f8b9eca4e97544f02bc55c464f8514#make-adjustments-in-remote-repository) about line ending issues with Quarto.~~
    ...
    ::: {.callout-important}
    Step 3 does no longer apply. I added this step 3 to my original post to prevent GitHub Actions from failing due to hash issues caused by end-of-line character differences between operating systems (see [my gist](https://gist.github.com/pjastam/03f8b9eca4e97544f02bc55c464f8514) for more). However, this step 3 is no longer needed since the removal of the hash issue by [this pull request](https://github.com/quarto-dev/quarto-cli/pull/5983).
    :::
