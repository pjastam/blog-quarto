...
The remote repository that results from the steps described in this step by step guide is located at [https://github.com/pjastam/template-quarto-website](https://github.com/pjastam/template-quarto-website). To use it as a template repository for your [Quarto](https://quarto.org/) websites, I have checked the `Template repository` box in the `Settings` tab of this remote repository.
...
3.  Delete the `_publish.yml` file and redo step 3 of the step by step guide above to create a new `_publish.yml` file with the {{< iconify bxl netlify >}} Netlify credentials for a connection a {{< iconify bxl netlify >}} Netlify site of your own.

4.  Finally, perform step 11 of the step by step guide above and your [Quarto](https://quarto.org/) website will be up and running in any moment.
