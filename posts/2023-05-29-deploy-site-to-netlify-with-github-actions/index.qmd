...
The remote repository is located at [https://github.com/pjastam/template-quarto-website/](https://github.com/pjastam/template-quarto-website/). Note that this repository is set up as a template, see [this section]{#a-versatile-template} below.
...
The remote repository that results from the steps described [in this guide]{#step-by-step-guide} is located at [https://github.com/pjastam/template-quarto-website](https://github.com/pjastam/template-quarto-website). To use it as a template repository for your (an my) [Quarto](https://quarto.org/) websites, I have checked the `Template repository` box in the `Settings` tab of this remote repository.
